...
import { Image as ImageIcon, Film, FileText, Sparkles, ArrowRight, Music, QrCode, Type, Code2, Package, Video } from "lucide-react";
...
export function DashboardGrid() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl mx-auto p-4">
      ...
      <Link href="/tools/audio" className="block group relative">
        <motion.div
          variants={cardVariants}
          whileHover="hover"
          whileTap="tap"
      ...
      {/* Lumina QR Master Card */}
      <Link href="/tools/qr" className="block group relative">
        <motion.div
          variants={cardVariants}
          whileHover="hover"
          whileTap="tap"
        ...
        >
           <motion.div
             variants={glowVariants}
             className="absolute inset-0 rounded-3xl ring-1 ring-cyan-500/50 z-20 pointer-events-none"
           />
           <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500" />

           <div className="relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center shadow-lg shadow-cyan-500/20 mb-6 group-hover:shadow-cyan-500/40 transition-shadow duration-300">
                <QrCode className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 to-blue-200 tracking-tight mb-1">
                {t('QRLab.title')}
              </h3>
              <p className="text-sm text-neutral-400 font-medium">
                {t('QRLab.description')}
           ...
           <div className="relative z-10 flex justify-end">
              <div className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center group-hover:bg-cyan-500 group-hover:border-cyan-500 transition-all duration-300">
                 <ArrowRight className="w-4 h-4 text-neutral-400 group-hover:text-white" />
              </div>
           </div>
        </motion.div>
      ...
      {/* Lumina Text Lab Card */}
      <Link href="/tools/text" className="block group relative">
        <motion.div
          variants={cardVariants}
          whileHover="hover"
          whileTap="tap"
        ...
        >
           <motion.div
             ...
             className="absolute inset-0 rounded-3xl ring-1 ring-blue-500/50 z-20 pointer-events-none"
           />
           <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-blue-500/10 via-indigo-500/5 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500" />

           <div className="relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg shadow-blue-500/20 mb-6 group-hover:shadow-blue-500/40 transition-shadow duration-300">
                <Type className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-indigo-200 tracking-tight mb-1">
                {t('TextLab.title')}
              </h3>
              <p className="text-sm text-neutral-400 font-medium">
                {t('TextLab.description')}
              </p>
           </div>
      ...
      {/* Lumina Dev Lab Card */}
      <Link href="/tools/dev" className="block group relative">
        <motion.div
          variants={cardVariants}
          whileHover="hover"
          whileTap="tap"
        ...
        >
           <motion.div
             ...
             className="absolute inset-0 rounded-3xl ring-1 ring-emerald-500/50 z-20 pointer-events-none"
           />
           <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-emerald-500/10 via-green-500/5 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500" />

           <div className="relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-500 flex items-center justify-center shadow-lg shadow-emerald-500/20 mb-6 group-hover:shadow-emerald-500/40 transition-shadow duration-300">
                <Code2 className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 to-green-200 tracking-tight mb-1">
                {t('DevLab.title')}
              </h3>
              <p className="text-sm text-neutral-400 font-medium">
                {t('DevLab.description')}
              </p>
           </div>
      ...
      {/* Lumina Archive Lab Card */}
      <Link href="/tools/archive" className="block group relative">
        <motion.div
          variants={cardVariants}
          whileHover="hover"
          whileTap="tap"
        ...
        >
           <motion.div
             variants={glowVariants}
             className="absolute inset-0 rounded-3xl ring-1 ring-amber-500/50 z-20 pointer-events-none"
           />
           <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500" />

           <div className="relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center shadow-lg shadow-amber-500/20 mb-6 group-hover:shadow-amber-500/40 transition-shadow duration-300">
                <Package className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-orange-200 tracking-tight mb-1">
                {t('ArchiveLab.title')}
              </h3>
              <p className="text-sm text-neutral-400 font-medium">
                {t('ArchiveLab.description')}
              </p>
           </div>

           <div className="relative z-10 flex justify-end">
              <div className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center group-hover:bg-amber-500 group-hover:border-amber-500 transition-all duration-300">
                 <ArrowRight className="w-4 h-4 text-neutral-400 group-hover:text-white" />
              </div>
           </div>
        </motion.div>
      ...
      {/* Lumina Recorder Card */}
      <Link href="/tools/recorder" className="block group relative">
        <motion.div
          variants={cardVariants}
          whileHover="hover"
          whileTap="tap"
        ...
        >
           <motion.div
             variants={glowVariants}
             className="absolute inset-0 rounded-3xl ring-1 ring-rose-500/50 z-20 pointer-events-none"
           />
           <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-rose-500/10 via-pink-500/5 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500" />

           <div className="relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-500 to-pink-500 flex items-center justify-center shadow-lg shadow-rose-500/20 mb-6 group-hover:shadow-rose-500/40 transition-shadow duration-300">
                <Video className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-rose-200 to-pink-200 tracking-tight mb-1">
                {t('Recorder.title')}
              </h3>
              <p className="text-sm text-neutral-400 font-medium">
           ...
           <div className="relative z-10 flex justify-end">
              <div className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center group-hover:bg-rose-500 group-hover:border-rose-500 transition-all duration-300">
                 <ArrowRight className="w-4 h-4 text-neutral-400 group-hover:text-white" />
              </div>
           </div>
        </motion.div>
